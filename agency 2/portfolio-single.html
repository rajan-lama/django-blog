...
<html lang="en">
   <head>
      ...
      <!-- Title -->
      <title>Efrekia | Onepage Multipurpose Website</title>
      <!-- Font Google -->
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="header-left">
							<a href=""><i class="fa fa-envelope"></i> info@efrekia.com</a>
							<a href=""><i class="fa fa-phone"></i> +216 27 159 132</a>
						</div>
					</div>
            ...
            <div class="row">
               <div class="col-xl-12">
                  <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="index.html"><img src="assets/img/logo_efrekia.png" height="100"  width="120"></a>
          ...
          <div class="col-lg-3 col-md-6">
             <div class="single-footer contact-box">
                ...
                <ul>
                   ...
                   <li><i class="fa fa-envelope"></i>  info@efrekia.com</li>
